        ...
        <div class="text-center">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb justify-content-center">
                    ...
                    <li class="breadcrumb-item text-white" aria-current="{{ ('about') }}">About Us</li>
                </ol>
            </nav>
        </div>
    ...
    <div class="ts_counter_bg parallax parallax2">
        ...
        <div class="container">
            <div class="row wow fadeInLeft text-center">
                ...
                <div class="col-12 text-center"><a href="{{'/portfolio'}}" class="btn btn-primary solid">See Our Portfolio</a></div>
